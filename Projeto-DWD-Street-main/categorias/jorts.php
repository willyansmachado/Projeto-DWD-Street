<?php
// BANCO DE DADOS SIMULADO EM PHP - JORTS
$produtos = [
    [
        "id" => 1,
        "badge" => "Mais Vendido",
        "categoria" => "Jeans",
        "titulo" => "Bermuda Jorts Jeans DWD Baggy – Lavagem Clara Vintage",
        "preco_antigo" => "R$ 199,00",
        "preco_atual" => "R$ 159,00",
        "parcelas" => "3x de R$ 53,00",
    ...
    [
        ...
        "badge" => "Heavy Cargo",
        "categoria" => "Cargo",
        "titulo" => "Bermuda Jorts Cargo DWD Multi-Pockets – Camuflada Desert",
    ...
    [
        ...
        "badge" => "Novo Drop",
        "categoria" => "Jeans",
        "titulo" => "Bermuda Jorts Jeans DWD Deep Black – Corte Off-Wide",
        "preco_antigo" => null,
        "preco_atual" => "R$ 169,00",
        "parcelas" => "3x de R$ 56,33",
    ...
    [
        ...
        "badge" => "Destaque",
        "categoria" => "Sarja",
        "titulo" => "Bermuda Jorts Sarja DWD Skate Fit – Off-White Heavy",
...
<style>
    ...
    * {
    ...
    /* BANNER HERO JORTS */
    .category-hero {
        background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.7)), url('../assets/css/img/bannerjorts.png') no-repeat center center/cover;
        text-align: center;
        padding: 100px 20px;
...
<body>
    ...
    <section class="category-hero">
        <h1>Jorts Coleção</h1>
        <p>Bermudas jeans baggy, cargo e sarja com modelagem extra larga e caimento abaixo do joelho</p>
    </section>
    ...
    <main class="shop-container">
        ...
        <div class="filter-bar">
            ...
            <button class="filter-btn">Jeans Baggy</button>
            <button class="filter-btn">Cargo</button>
            <button class="filter-btn">Sarja</button>
        </div>

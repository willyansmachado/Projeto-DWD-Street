<?php
// BANCO DE DADOS SIMULADO EM PHP - JOIAS E ACESSÓRIOS
$produtos = [
    [
        "id" => 1,
        "badge" => "Prata 925",
        "categoria" => "Correntes",
        "titulo" => "Corrente Grumet Italiana 4mm - Prata 925 Legítima",
    ...
    [
        ...
        "badge" => "Novo",
        "categoria" => "Pingentes",
        "titulo" => "Pingente DWD Ice Cross - Cravejado Zircônia",
        "preco_antigo" => "R$ 199,00",
        "preco_atual" => "R$ 159,00",
        "parcelas" => "3x de R$ 53,00",
        "imagem" => "https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?q=80&w=500"
    ]
];
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Joias e Acessórios - DWD Street</title>
...
<style>
  ...
  /* ==========================================================================
    ...
    /* BANNER DE CATEGORIA HERO (Apontando para fora da pasta categorias) */
    .category-hero {
        background: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.6)), url('../assets/css/img/bannerrelogio.png') no-repeat center center/cover;
        text-align: center;
        padding: 100px 20px;
...
<body>
    ...
    <section class="category-hero">
        <h1>Joias & Correntes</h1>
        <p>Acessórios de peso em Prata 925 e acabamento premium para o seu estilo</p>
    </section>
    ...
    <main class="shop-container">
        ...
        <div class="filter-bar">
            ...
            <button class="filter-btn">Correntes</button>
            <button class="filter-btn">Pulseiras</button>
            <button class="filter-btn">Anéis</button>
            <button class="filter-btn">Pingentes</button>
        </div>

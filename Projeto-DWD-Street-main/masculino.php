...
// BANCO DE DADOS SIMULADO - PRODUTOS MASCULINOS
$produtos_masculinos = [
    [
        "id" => 1,
        ...
        "imagem_hover" => "assets/img/oversized_hover.png", // <- COLOQUE A SEGUNDA FOTO AQUI
        "alt" => "Camiseta Oversized Preta"
    ],
    [
        "id" => 2,
        "nome" => "Calça Cargo DWD",
        "preco" => 249.90,
        "imagem" => "assets/img/camiseta_banner.png",
        "imagem_hover" => "assets/img/cargo_hover.png", // <- COLOQUE A SEGUNDA FOTO AQUI
        "alt" => "Calça Cargo Preta"
    ],
    [
        "id" => 3,
        "nome" => "Moletom Street Essential",
        "preco" => 299.90,
        "imagem" => "assets/img/camiseta_banner.png",
        "imagem_hover" => "assets/img/moletom_hover.png", // <- COLOQUE A SEGUNDA FOTO AQUI
        "alt" => "Moletom Street Essential"
    ],
    [
        "id" => 4,
        "nome" => "Jaqueta Corta Vento DWD",
        "preco" => 349.90,
        "imagem" => "assets/img/camiseta_banner.png",
        "imagem_hover" => "assets/img/cortavento_hover.png", // <- COLOQUE A SEGUNDA FOTO AQUI
...
<head>
    ...
    <title>Masculino | DWD Street</title>
    ...
    <style>
        ...
        * {
        ...
        /* CONTAINER DA IMAGEM ATUALIZADO PARA SUPORTAR O HOVER COGNITIVO */
        ...
        /* Estilização das duas fotos em camadas */
        ...
        /* Troca fluida ao passar o mouse */
...
<body>
    ...
    <header class="navbar">
        ...
        <nav>
            <ul class="nav-links">
                ...
                <li><a href="masculino.php" style="color: var(--accent);">Masculino</a></li>
    ...
    <main class="container">
        <div class="breadcrumb">HOME > MASCULINO</div>
        <h2 class="titulo-secao">Coleção Masculina</h2>
        
        <div class="product-grid">
            <?php foreach ($produtos_masculinos as $produto): ?>
                <div class="product-card">
                    <div class="img-container">
                        <img class="img-default" src="<?= $produto['imagem'] ?>" alt="<?= $produto['alt'] ?>">
                        <img class="img-hover" src="<?= $produto['imagem_hover'] ?>" alt="<?= $produto['alt'] ?> - Detalhe">
                    </div>
                    <div>
                        <h3><?= $produto['nome'] ?></h3>

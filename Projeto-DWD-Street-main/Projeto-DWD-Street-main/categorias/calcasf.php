<?php
// BANCO DE DADOS SIMULADO EM PHP - CALÇAS FEMININAS
$produtos = [
    [
        "id" => 1,
        "badge" => "Tendência",
        "categoria" => "Parachute",
        "titulo" => "Calça Parachute Feminina DWD Over – Verde Militar",
        "preco_antigo" => "R$ 279,00",
        "preco_atual" => "R$ 219,00",
        "parcelas" => "5x de R$ 43,80",
        "imagem" => "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?q=80&w=500"
    ],
    [
        "id" => 2,
        "badge" => "Mais Vendido",
        "categoria" => "Cargo",
        "titulo" => "Calça Cargo Feminina DWD Multi-Pockets – All Black",
        "preco_antigo" => "R$ 249,00",
        "preco_atual" => "R$ 199,00",
        "parcelas" => "4x de R$ 49,75",
        "imagem" => "https://images.unsplash.com/photo-1517423568366-8b83523034fd?q=80&w=500"
    ],
    [
        "id" => 3,
        "badge" => "Novo",
        "categoria" => "Jeans",
        "titulo" => "Calça Jeans Wide Leg Streetwear DWD – Lavagem Detonada",
        "preco_antigo" => null,
    ...
    [
        ...
        "badge" => "Destaque",
        "categoria" => "Joggers",
        "titulo" => "Calça Jogger Moletom Heavy DWD – Cinza Mescla",
        "preco_antigo" => "R$ 189,00",
        "preco_atual" => "R$ 149,00",
        "parcelas" => "3x de R$ 49,66",
        "imagem" => "https://images.unsplash.com/photo-1551854838-212c50b4c184?q=80&w=500"
    ]
];
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Calças Femininas - DWD Street</title>
...
/* ==========================================================================
    ...
    /* BANNER HERO CALÇAS FEMININAS */
    .category-hero {
        background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.7)), url('../assets/css/img/bannercalcasfem.png') no-repeat center center/cover;
        text-align: center;
        padding: 100px 20px;
...
<body>
    ...
    <section class="category-hero">
        ...
        <p>Modelagens Parachute, Cargo e Wide Leg com caimento largo e autêntico</p>
    </section>
    ...
    <main class="shop-container">
        ...
        <div class="filter-bar">
            ...
            <button class="filter-btn">Parachute</button>
            <button class="filter-btn">Cargo</button>
            <button class="filter-btn">Wide Leg Jeans</button>

...
<body class="auth-body">
    ...
    <div class="auth-container">
        <h1 style="font-weight: 900; margin-bottom: 5px; font-size: 2.2rem; letter-spacing: -1px;">
            DWD<span style="color: var(--brand-color);">STREET</span>
        </h1>
        ...
        <form class="auth-form" action="login.php" method="POST">
            <div class="input-group">
                <label>E-mail</label>
                <input type="email" name="email" placeholder="seu@email.com" class="auth-input" required autocomplete="email">
            </div>

            <div class="input-group">
                <label>Senha</label>
                <input type="password" name="senha" placeholder="Sua senha" class="auth-input" required autocomplete="current-password">
            </div>
